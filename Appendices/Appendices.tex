...
\begin{document}
	...
	\begin{figure}[h]
		\centering
		\includegraphics[width=.9\textwidth]{"Survey/file-page1"}
		\vspace{-100pt}
	\end{figure} \clearpage
    
	\begin{figure}[h]
		\centering
		\includegraphics[width=1\textwidth]{"Survey/file-page2"}
	\end{figure} \clearpage
    
	\begin{figure}[h]
		\centering
		\includegraphics[width=1\textwidth]{"Survey/file-page3"}
	\end{figure} \clearpage
    
	\begin{figure}[h]
		\centering
		\includegraphics[width=1\textwidth]{"Survey/file-page4"}
	\end{figure} \clearpage
...
\pagebreak
    ...
    \includepdf[pages={2-}]{API/EmergencyClient.pdf}
    \includepdf[pages={-}]{API/EmergencyServer.pdf}
